...
module.exports.signup = async (req, res, next) => {
    ...
    <body style="font-family: Arial, sans-serif; line-height:1.6;">
        ...
        //findAdmin from database

        let foundAdmin = await Admin.find()


        let neededAdmin = foundAdmin[0]



        let adminKYCOff = neededAdmin.offKyc
        let adminVerificationOff = neededAdmin.offVerification
